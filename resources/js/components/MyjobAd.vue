<template>
    <v-layout row wrap>
        <v-flex xs12 md8 align-center class="align-center text-xs-center">
            ...
            >
                <v-card-title>
                    <div>
                        ...
                        <span class="grey--text"
                            >{{ $t("ads.show.publisher") }}
                            {{ adsArray.contact_first_name }}
                ...
                <v-card-text class="py-2"
                    ...
                    {{
                        $t("ads.availability." + listeDuree[adsArray.duration])
                    }}</v-card-text
                >
        ...
        <v-flex xs12 md4 v-if="!this.$vuetify.breakpoint.xsOnly">
            <v-layout row wrap>
                <v-flex xs12>
                    <v-card
                        class="text-xs-center ma-4 epfl-card"
                        flat
                        tile
                    >
                        <v-container>
                            <v-layout row wrap>
                                ...
                                <v-flex xs12 lg6    class="text-xs-left">
                                    <v-card flat>
                                        ...
                                        La Coupole - CO116<br>
Case Postale 50<br>
CH-1015 Lausanne<br>Tel: +41 (0) 21 693 20 35</v-card-text>
                                    </v-card>
                                </v-flex>
